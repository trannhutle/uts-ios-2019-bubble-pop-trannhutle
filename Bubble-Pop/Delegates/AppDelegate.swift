...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func getStandingList() -> [ScoreEntity]{
        ...
        do{
            ...
            fatalError("Can't fech cars")
        }
    }
    func saveScore(playerName: String, score: Int16){
        let highScoreEntity = ScoreEntity(context: persistentContainer.viewContext)
        highScoreEntity.playerName = playerName
        highScoreEntity.score = score
        self.saveContext()
    }
